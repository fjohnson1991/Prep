...
extension LoginViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "videoSegue" {
            _ = segue.destination as! HeartRateViewController
        }
    }
...
extension LoginViewController {
    ...
    func loadViews() {
        ...
        newuserButton.setTitleColor(UIColor.themePink, for: .normal)
        ...
        signupButton.setTitleColor(UIColor.themePink, for: .normal)
